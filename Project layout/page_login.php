        ...
        <?php display_flash_message('success'); ?>
            ...
            <form action="auth_handler.php" method="post">
                <div class="form-group">
                    ...
                    <input type="email" name="enteredEmail" id="username" class="form-control" placeholder="Эл. адрес" value="">
                </div>
                <div class="form-group">
                    <label class="form-label" for="password">Пароль</label>
                    <input type="password" name="enteredPassword" id="password" class="form-control" placeholder="" >
                </div>
