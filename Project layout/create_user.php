    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-plus-circle'></i> Добавить нового работника
            </h1>
                    ...
                    <div id="panel-1" class="panel">
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <!-- title -->
                                <div class="form-group">
                                    <label class="form-label" for="jobTitle">Должность</label>
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status" id="example-select">
                                        <option value="status status-success mr-3" >Онлайн</option>
                                        <option value="status status-warning mr-3">Отошел</option>
                                        <option value="status status-danger mr-3">Не беспокоить</option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Загрузить аватар</label>
                                    <input type="file" name="image" id="simpleinput" class="form-control-file">
                                </div>
                            </div>
                        </div>
